...
import { IFindPwDataProps } from "../../../interface/FindAuthData/FindAuthData.type";
...
const FindPwForm: React.FC = () => {
  const [checkData, setCheckData] = useState<IFindPwDataProps>({
    id: "",
    name: "",
    birth: "",
    email: "",
  ...
  return (
    <>
      ...
      <FindAuthDataSubmitButtonWrap>
        <SubmitButton big text={"다음"} blue disable={isNull} />
      </FindAuthDataSubmitButtonWrap>
    </>
  );
};
